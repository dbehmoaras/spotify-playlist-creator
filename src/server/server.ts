...
const scopes =
  "user-read-email user-top-read user-read-recently-played user-follow-modify user-read-currently-playing user-library-read playlist-modify-public playlist-modify-private";
...
app.get("/login", (req, res) => {
  res.redirect(
    "https://accounts.spotify.com/authorize" +
      ...
      "&redirect_uri=" +
      encodeURIComponent(spotifyCallbackURI)
  );
});
